...
"}")
        ...
        self.viewfolderBTN = QtWidgets.QPushButton(self.widget_2)
        self.viewfolderBTN.setMinimumSize(QtCore.QSize(600, 0))
        self.viewfolderBTN.setMaximumSize(QtCore.QSize(600, 16777215))
        self.viewfolderBTN.setStyleSheet("QPushButton {\n"
"    background-color: white;\n"
"    border: 2px solid #67B99A;\n"
"    color: black;\n"
"    padding: 8px 16px;\n"
...
"    border: 2px solid #265C42;\n"
"}")
        self.viewfolderBTN.setObjectName("viewfolderBTN")
        self.verticalLayout_4.addWidget(self.viewfolderBTN)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filelocDISPLAY.setText(_translate("MainWindow", "Put File Location Here"))
        self.viewfolderBTN.setText(_translate("MainWindow", "View Backup Folder"))
