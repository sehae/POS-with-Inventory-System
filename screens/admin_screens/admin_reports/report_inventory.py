...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -1325, 656, 1980))
        ...
        self.levelView = QtWidgets.QGraphicsView(self.widget_8)
        ...
        self.verticalLayout_10.addWidget(self.levelView)
        ...
        self.statusView = QtWidgets.QGraphicsView(self.widget_9)
        ...
        self.verticalLayout_11.addWidget(self.statusView)
        ...
        self.expiryView = QtWidgets.QGraphicsView(self.widget_10)
        ...
        self.verticalLayout_12.addWidget(self.expiryView)
...
"Analysis"))
        ...
        self.label_5.setText(_translate("MainWindow", "Inventory Levels by Products"))
        self.label_6.setText(_translate("MainWindow", "Inventory Status Overview"))
        self.label_7.setText(_translate("MainWindow", "Expiry Date Analysis"))
