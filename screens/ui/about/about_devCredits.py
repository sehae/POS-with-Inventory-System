...
"}")
        ...
        self.label_3.setPixmap(QtGui.QPixmap(":/devCredits/Dev Credits/devCredits_ymnwl.jpg"))
        ...
        self.label_4.setPixmap(QtGui.QPixmap(":/devCredits/Dev Credits/devCredits_bryan.png"))
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.widget_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_8.setText(_translate("MainWindow", "<html><head/><body><p>Role/Title: UI/UX Developer</p><p>Contributions: Created the visual design and user flow, conducted user testing and feedback sessions.</p><p>Contact: qyjpfaurillo@tip.edu.ph</p><p>LinkedIn: <a href=\"https://www.linkedin.com/in/ymnwl-jan-faurillo-3b744b2a9/\"><span style=\" text-decoration: underline; color:#0000ff;\">Ymnwl Faurillo</span></a></p><p>GitHub: <a href=\"https://github.com/ImNotKrakeN\"><span style=\" text-decoration: underline; color:#0000ff;\">ImNotKraken</span></a></p><p><br/></p></body></html>"))
        self.label_7.setText(_translate("MainWindow", "Bryan Dominick A. Tiamzon"))
        self.label_10.setText(_translate("MainWindow", "<html><head/><body><p>Role/Title: Full Stack Developer</p><p>Contributions: Designed and implemented inventory module, optimized the database schema,and navigation.</p><p>Contact: qbdatiamzon@tip.edu.ph</p><p>LinkedIn: <a href=\"https://www.linkedin.com/in/bryantiamzonph/\"><span style=\" text-decoration: underline; color:#0000ff;\">Bryan Tiamzon</span></a></p><p>GitHub: <a href=\"https://github.com/officialbryx\"><span style=\" text-decoration: underline; color:#0000ff;\">officialbryx</span></a></p><p><br/></p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "Leah Desiree B. Villatura"))
        self.label_9.setText(_translate("MainWindow", "<html><head/><body><p>Role/Title: Full Stack Developer</p><p>Contributions: A Full Stack Developer in a POS system designs and implements both the user interface and </p><p>backend logic, integrates databases, and ensures security, </p><p>Contact: qldbvillatura@tip.edu.ph</p><p>LinkedIn: <a href=\"https://www.linkedin.com/in/leah-desiree-v-7443342a8/\"><span style=\" text-decoration: underline; color:#0000ff;\">Leah Villatura</span></a></p><p>GitHub: <a href=\"https://github.com/sehae\"><span style=\" text-decoration: underline; color:#0000ff;\">sehae</span></a></p><p><br/></p></body></html>"))
