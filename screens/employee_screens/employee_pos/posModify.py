...
"}")
        ...
        self.widget1.setGeometry(QtCore.QRect(20, 20, 1171, 461))
        ...
        self.searchLBL = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        ...
        self.searchFIELD = QtWidgets.QLineEdit(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.orderLabel_2 = QtWidgets.QLabel(self.widget1)
        font = QtGui.QFont()
        font.setPointSize(15)
